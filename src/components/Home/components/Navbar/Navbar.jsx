...
const Navbar = () => {
  ...
  return (
    <>
      {open && <DropdownMenu list={categoryList} />}
      <div className={styles.root}>
        <div className={styles.logoContainer}>
          ...
          <div className={styles.buttonContainer}>
            <button onClick={() => dropDownMenuHandler()}>categorias</button>
          </div>
        </div>
        ...
        <div className={styles.profile}>
          <button onClick={goToProfile}>Registrate</button>
          <button onClick={goToProfile}>Inicia Sesion</button>
          <a href="">
